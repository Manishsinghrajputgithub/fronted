// src/components/BookieCorner/OcCuttingCombined.js
import React from 'react';

const OcCuttingCombined = () => {
  return (
    <div className="p-6 pt-20 max-w-7xl mx-auto">
      <h1 className="text-2xl font-bold mb-6">OC Cutting Combined</h1>
      ...
      <div className="bg-white shadow-lg rounded-lg border border-gray-200 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          {/* Percent Input */}
          <div className="flex flex-col">
            <label htmlFor="percent" className="font-semibold mb-2">Percent</label>
            <input
              type="text"
              id="percent"
              placeholder="Enter percent (leave blank for 100%)"
              className="border border-gray-300 rounded-lg p-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
            />
          </div>
        </div>
...
export default OcCuttingCombined;
